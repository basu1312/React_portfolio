...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const check = async () => {
      ...
      try {
        const r2 = await fetch('/Basu_Sharma_Resume.pdf', { method: 'HEAD' });
        if (!cancelled && r2.ok) {
          setResumeUrl('/Basu_Sharma_Resume.pdf');
          setDownloadName('Basu_Sharma_Resume.pdf');
        }
    ...
    <section id="home" className="section hero-section">
      ...
      >
        ...
        <p className="hero-bio">
          ...
          high-performance web applications for Banking, E-Commerce and
          financial systems. Specialist in React, TypeScript, Design Systems and
