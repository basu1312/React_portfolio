      ...
      <div className="hero-content">
        ...
        >
          ...
          <p className="hero-bio">
            Lead Frontend Engineer with 7+ years delivering scalable, secure,
            and high-performance web applications for Banking, E-Commerce and
            financial systems. <br />
            Specialist in React, TypeScript, Design Systems and Micro-Frontend
            Architecture.
          </p>
